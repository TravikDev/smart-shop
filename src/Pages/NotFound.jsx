  ...
  return (
    ...
    <article className="p-4 gap-4">
      ...
      <h1 className="text-2xl  ml-1 text-black">Unknown Page</h1> 
        ...
        <Link to="/smart-shop"><button class="mb-2 flex border-2 border-opacity-80 rounded-md border-sky-800 hover:bg-sky-900 bg-sky-600 text-white hover:text-white px-1 text-lg sm:text-sm">Home Page</button></Link>
      </div>
      </section>
